...
| <a name="input_vault_pki_intermediate_ca"></a> [vault\_pki\_intermediate\_ca](#input\_vault\_pki\_intermediate\_ca) | Configuration for the Vault PKI intermediate CA certificate. | <pre>object({<br/>    common_name = optional(string, "Vault Intermediate CA")<br/>    key_type    = optional(string, "ec")<br/>    key_bits    = optional(number, 384)<br/>  })</pre> | `{}` | no |
