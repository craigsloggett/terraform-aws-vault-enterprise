...
| <a name="input_hcp_terraform"></a> [hcp\_terraform](#input\_hcp\_terraform) | HCP Terraform JWT auth configuration for Terraform-managed Vault administration. | <pre>object({<br/>    hostname     = optional(string, "app.terraform.io")<br/>    org_name     = string<br/>    workspace_id = string<br/>  })</pre> | n/a | yes |
